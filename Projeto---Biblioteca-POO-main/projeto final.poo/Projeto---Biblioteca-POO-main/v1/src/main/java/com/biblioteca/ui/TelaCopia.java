...
public class TelaCopia extends TelaBaseCadastro {
    ...
    public TelaCopia() {
        ...
        JPanel fundo = criarFundoCadastro("Gerenciar Cópias");

        JPanel container = new JPanel(new BorderLayout(10, 10));
        container.setOpaque(false);
        container.setBorder(BorderFactory.createEmptyBorder(10, 30, 25, 30));

        JPanel painelFormulario = criarCardFormulario(4, 2);
        ...
        painelFormulario.add(new JLabel("Código Patrimônio:"));
        txtCodigoPatrimonio = new JTextField();
        painelFormulario.add(txtCodigoPatrimonio);
        ...
        btnAtualizar.addActionListener(e -> atualizarCopia());
        btnExcluir.addActionListener(e -> excluirCopia());
        ...
        modeloTabela.addColumn("Código Patrimônio");
    ...
    private void salvarCopia() {
        try {
            if (txtCodigoPatrimonio.getText().trim().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Digite o código patrimônio!");
                return;
            }
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao salvar cópia: " + erro.getMessage());
        }
    }
    ...
    private void atualizarCopia() {
        try {
            ...
            copia.setId(Integer.parseInt(txtId.getText()));
            copia.setCodigoPatrimonio(txtCodigoPatrimonio.getText());
            copia.setStatus(comboStatus.getSelectedItem().toString());
            copia.setObra((Obra) comboObra.getSelectedItem());
            ...
            JOptionPane.showMessageDialog(this, "Cópia atualizada!");
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao atualizar cópia: " + erro.getMessage());
        }
    }
    ...
    private void excluirCopia() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Cópia excluída!");
            ...
            JOptionPane.showMessageDialog(this,
                    "Erro ao excluir cópia: " + erro.getMessage());
        }
    }
    ...
    private void carregarTabela() {
        try {
            ...
            for (Copia copia : lista) {
                ...
                Obra obraCompleta = obraDAO.buscarPorId(copia.getObra().getId());
    ...
    private void preencherCamposDaTabela() {
        ...
        if (linha >= 0) {
            ...
            txtCodigoPatrimonio.setText(modeloTabela.getValueAt(linha, 1).toString());
